...
<div class="row breadcrumb forums">
    <?php
      echo l(t('View Forum Rules'), 'node/390', array('attributes'=>array('class' => array('forum_rules'))));
